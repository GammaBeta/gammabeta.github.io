...
const NpcModels = [
    new NpcBuilder(Npcs.Guide).likes(Biomes.Forest, Npcs.Princess, Npcs.Clothier, Npcs.Zoologist).dislikes(Biomes.Ocean, Npcs.Steampunker).hates(Npcs.Painter).build(),
