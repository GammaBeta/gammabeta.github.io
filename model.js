...
const NpcBuilder = function (npcName) {
  ...
  this.loves = function (things) {
    this.npc.Loved = this.npc.Loved.concat(Array.from(arguments));
    return this;
  };
  this.likes = function (things) {
    this.npc.Liked = this.npc.Liked.concat(Array.from(arguments));
    return this;
  };
  this.dislikes = function (things) {
    this.npc.Disliked = this.npc.Disliked.concat(Array.from(arguments));
    return this;
  };
  this.hates = function (things) {
    this.npc.Hated = this.npc.Hated.concat(Array.from(arguments));
    return this;
  };
  this.build = function () {
    return this.npc;
...
const NpcModels = [
  ...
  new NpcBuilder(Npcs.Merchant)
    .likes(Biomes.Forest, Npcs.Golfer, Npcs.Nurse, Npcs.Princess)
    .dislikes(Biomes.Desert, Npcs.TaxCollector)
    .hates(Npcs.Angler)
    .build(),
  new NpcBuilder(Npcs.Nurse)
    .loves(Npcs.ArmsDealer)
    .likes(Biomes.Hallow, Npcs.Wizard, Npcs.Princess)
    .dislikes(Biomes.Snow, Npcs.Dryad, Npcs.PartyGirl)
  ...
  new NpcBuilder(Npcs.Demolitionist)
    ...
    .dislikes(Biomes.Ocean, Npcs.ArmsDealer, Npcs.GoblinTinkerer)
    .build(),
  new NpcBuilder(Npcs.DyeTrader)
    .likes(Biomes.Desert, Npcs.ArmsDealer, Npcs.Painter, Npcs.Princess)
    .dislikes(Biomes.Forest, Npcs.Steampunker)
    .hates(Npcs.Pirate)
    .build(),
  ...
  new NpcBuilder(Npcs.Zoologist)
    ...
    .likes(Biomes.Forest, Npcs.Golfer, Npcs.Princess)
    .dislikes(Biomes.Desert, Npcs.Angler)
    .hates(Npcs.ArmsDealer)
    .build(),
  new NpcBuilder(Npcs.Dryad)
    .likes(Biomes.Jungle, Npcs.WitchDoctor, Npcs.Truffle, Npcs.Princess)
    .dislikes(Biomes.Desert, Npcs.Angler)
    .hates(Npcs.Golfer)
    .build(),
  new NpcBuilder(Npcs.Painter)
    .loves(Npcs.Dryad)
    .likes(Biomes.Jungle, Npcs.PartyGirl, Npcs.Princess)
    .dislikes(Biomes.Forest, Npcs.Truffle, Npcs.Cyborg)
    .build(),
  new NpcBuilder(Npcs.Golfer)
    .loves(Npcs.Angler)
    .likes(Biomes.Forest, Npcs.Painter, Npcs.Zoologist, Npcs.Princess)
    .dislikes(Biomes.Underground, Npcs.Pirate)
    .hates(Npcs.Merchant)
    .build(),
  new NpcBuilder(Npcs.ArmsDealer)
    .loves(Npcs.Nurse)
    .likes(Biomes.Desert, Npcs.Steampunker, Npcs.Princess)
    .dislikes(Biomes.Snow, Npcs.Golfer)
    .hates(Npcs.Demolitionist)
    .build(),
  new NpcBuilder(Npcs.Tavernkeep)
    .loves(Npcs.Demolitionist)
    .likes(Biomes.Hallow, Npcs.GoblinTinkerer, Npcs.Princess)
    .dislikes(Biomes.Snow, Npcs.Guide)
    .hates(Npcs.DyeTrader)
    .build(),
  new NpcBuilder(Npcs.Stylist)
    .loves(Npcs.DyeTrader)
    .likes(Biomes.Ocean, Npcs.Pirate, Npcs.Princess)
    .dislikes(Biomes.Snow, Npcs.Tavernkeep)
    .hates(Npcs.GoblinTinkerer)
    .build(),
  ...
  new NpcBuilder(Npcs.WitchDoctor)
    .likes(Biomes.Jungle, Npcs.Dryad, Npcs.Guide, Npcs.Princess)
    .dislikes(Biomes.Hallow, Npcs.Nurse)
    .hates(Npcs.Truffle)
    .build(),
  new NpcBuilder(Npcs.Clothier)
    .loves(Npcs.Truffle)
    .likes(Biomes.Underground, Npcs.TaxCollector, Npcs.Princess)
    .dislikes(Biomes.Hallow, Npcs.Nurse)
    .hates(Npcs.Mechanic)
    .build(),
  new NpcBuilder(Npcs.Mechanic)
    .loves(Npcs.GoblinTinkerer)
    .likes(Biomes.Snow, Npcs.Cyborg, Npcs.Princess)
    .dislikes(Biomes.Underground, Npcs.ArmsDealer)
    .hates(Npcs.Clothier)
    .build(),
  new NpcBuilder(Npcs.PartyGirl)
    .loves(Npcs.Wizard, Npcs.Zoologist)
    .likes(Biomes.Hallow, Npcs.Stylist, Npcs.Princess)
    .dislikes(Biomes.Underground, Npcs.Merchant)
    .hates(Npcs.TaxCollector)
    .build(),
  new NpcBuilder(Npcs.Wizard)
    .loves(Npcs.Golfer)
    .likes(Biomes.Hallow, Npcs.Merchant, Npcs.Princess)
    .dislikes(Biomes.Ocean, Npcs.WitchDoctor)
    .hates(Npcs.Cyborg)
    .build(),
  new NpcBuilder(Npcs.TaxCollector)
    .loves(Npcs.Merchant)
    .likes(Biomes.Snow, Npcs.PartyGirl, Npcs.Princess)
    .dislikes(Biomes.Hallow, Npcs.Demolitionist, Npcs.Mechanic)
    .hates(Npcs.SantaClaus)
    .build(),
  new NpcBuilder(Npcs.Truffle)
    .loves(Npcs.Guide)
    .likes(Biomes.Mushroom, Npcs.Dryad, Npcs.Princess)
    .dislikes(Npcs.Clothier)
    .hates(Npcs.WitchDoctor)
    .build(),
  new NpcBuilder(Npcs.Pirate)
    .loves(Npcs.Angler)
    .likes(Biomes.Ocean, Npcs.Tavernkeep, Npcs.Princess)
    .dislikes(Biomes.Underground, Npcs.Stylist)
    .hates(Npcs.Guide)
    .build(),
  new NpcBuilder(Npcs.Steampunker)
    .loves(Npcs.Cyborg)
    .likes(Biomes.Desert, Npcs.Painter, Npcs.Princess)
  ...
  new NpcBuilder(Npcs.SantaClaus)
    .loves(Biomes.Snow)
    .likes(Npcs.Princess)
    .hates(Biomes.Desert, Npcs.TaxCollector)
    .build(),
